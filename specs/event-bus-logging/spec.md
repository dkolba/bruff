...
- Contributor guidance audit → `AGENTS.md`, `packages/game/AGENTS.md`, `packages/utils/AGENTS.md`, `packages/game-element/AGENTS.md`, `.agents/skills/verify-layers/SKILL.md`, and `.agents/skills/roguelike-feature/SKILL.md` updated to describe the event-bus logging boundary.
