...
- [x] T9 — Update utils documentation in `packages/utils/README.md` and `packages/utils/AGENTS.override.md`
...
- [x] T13 — Update game import boundary docs in `packages/game/AGENTS.override.md`
- [x] T14 — Update game-element import boundary docs in `packages/game-element/AGENTS.override.md` and `packages/game-element/README.md`
